...
# Extend this by incorporating Cell object
def create_visible_region(scr_w,scr_h,offset_w=20,offset_h=20):
    return pygame.Rect(0+offset_w,0+offset_h,scr_w-2*offset_w,scr_h-2*offset_h)


def draw_visible_region(screen,visible_region,thickness=2):
    # Draw the viewable region
    pygame.draw.rect(screen,colors['BLACK'],visible_region,width=0)
    pygame.draw.rect(screen,colors['GOLD'],visible_region,width=thickness)
...
# TODO: PLEASE DOCUMENT YOUR CODE
